      ...
      <section className="providers">
        <div className="container">
          ...
          <div className="providers-grid">
            ...
            {/* Google Cloud */}
            <div className="provider-card">
              <svg viewBox="0 0 256 211" xmlns="http://www.w3.org/2000/svg" style={{width: 140, height: 48}}>
                <path d="M155.9 66.6l16.6-16.6 1.1-7C141.2 13.6 97.2 4 57.7 14.4 36 20 17.2 32.1 3.6 48.3L20 50.5l53.7 9.8 4.2-4.3c16.9-18.5 44.5-23.8 67.5-14.1 4.1 1.8 7.9 4.1 10.5 6.2v18.5z" fill="#EA4335"/>
                <path d="M199.5 48.3c-7.8-28.8-29-53-57.8-65.8l-57.4 57.4c10.6 8.6 16.7 21.5 16.3 35.1v4.9c13.5 0 24.5 11 24.5 24.5s-11 24.5-24.5 24.5H76.1l-4.8 5.2v29.3l4.8 4.7h24.5c34.3.3 63.6-22.7 73.1-55.6 6-21.3 2.4-44.2-8.2-64.2h34z" fill="#4285F4"/>
                <path d="M76.1 213.2H100.6v-53.7H76.1c-17.5 0-35-7.7-46.7-21L11.8 155.8l-8.7 17.2c16.9 25.1 45.4 40.4 73 40.2z" fill="#34A853"/>
                <path d="M76.1 53.8C41.8 54 11.4 77 2 110c-5.9 21.2-2.4 44 8.1 64l28.3-28.3c-9.3-21.4-4.8-46.8 11.4-63.1 6.8-6.8 15.3-11.5 24.5-14.2 9.2-2.7 18.8-2.5 28.2.1l40.9-40.9C129.2 16.5 103 3.9 76.1 53.8z" fill="#FBBC05"/>
              </svg>
